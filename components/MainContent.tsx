      ...
      <div className="call-screen">
        <div className="keypad-section">
          <div className="keypad-top">
            <button className="keypad-top-button">
              <img src="/images/user-add-plus--actions-add-close-geometric-human-person-plus-single-up-user.svg" alt="Add" />
            </button>
            ...
            >
              <img src="/images/arrow-up-1--arrow-up-keyboard.svg" alt="Back" />
            </button>
          </div>
        ...
        <div className="contact-section">
          <div className="tab-buttons">
            ...
            >
              <img className="tab-icon" src="/images/circle-clock--clock-loading-measure-time-circle.svg" alt="Recent" />
              Recent
            </button>
            <button 
            ...
            >
              <img className="tab-icon" src="/images/user-multiple-group--close-geometric-human-multiple-person-up-user.svg" alt="Contacts" />
              Contacts
            </button>
          </div>
